  ...
  return (
    <aside className="text-xs text-gray-500 leading-relaxed space-y-5">
      <div>
        ...
        <p className="mb-2">
          Baligács (2026) her temporal klik için en fazla <strong className="text-gray-900">7n</strong> kenar
      ...
      <div>
        ...
        <p>
          ...
          Klikler için toplam: <strong className="text-gray-900">f(n) &le; 7n</strong>.
        </p>
      </div>
